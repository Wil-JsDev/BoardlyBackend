...
public class GeneradorPdf : IGeneradorPdf<ProyectoDatosPdf>
{
    public async Task<byte[]> GenerarReporteAsync(ProyectoDatosPdf datos)
    {
        ...
        var documento = Document.Create(container =>
        {
            container.Page(page =>
            {
                ...
                page.Header().Height(50).Text("Reporte de Proyectos").FontSize(16).Bold().AlignCenter();
                ...
                {
                    datos = datos with { Fecha = DateTime.UtcNow };
