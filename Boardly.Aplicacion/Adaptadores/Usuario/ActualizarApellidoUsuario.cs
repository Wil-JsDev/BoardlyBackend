...
public class ActualizarApellidoUsuario(
    IUsuarioRepositorio repositorioUsuario,
    ILogger<ActualizarNombreUsuario> logger
) : IActualizarApellidoUsuario<ActualizarPropiedadUsuarioDto,ActualizarUsuarioDto>
{
    public async Task<ResultadoT<ActualizarUsuarioDto>> ActualizarApellidoUsuarioAsync(Guid id, ActualizarPropiedadUsuarioDto solicitud, CancellationToken cancellationToken)
    {
        ...
        usuario.Apellido = solicitud.propiedad;
